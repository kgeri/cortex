...
public interface Transport extends Closeable {
	 ...
	 */
	<R> void callAsync(SocketAddress address, Message message, MessageCallback<R> callback)
	 ...
	 * @throws InterruptedException on connection timeout
	 */
	void callAsync(SocketAddress address, Message message) throws InterruptedException;
